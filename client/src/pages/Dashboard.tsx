      ...
      <Box sx={{ 
        ...
        <Card 
          ...
          sx={{ 
            ...
            '&::before': {
              ...
              right: 0,
              height: '4px',
              background: `linear-gradient(90deg, #1aae7a 0%, #10B981 100%)`,
              transform: 'scaleX(0)',
        ...
        <Card sx={{ 
          ...
          '&::before': {
            ...
            right: 0,
            height: '4px',
            background: `linear-gradient(90deg, #8135e6 0%, #A78BFA 100%)`,
            transform: 'scaleX(0)',
            transformOrigin: 'left',
            transition: 'transform 0.3s ease',
          },
        ...
        <Card sx={{ 
          ...
          '&::before': {
            ...
            right: 0,
            height: '4px',
            background: `linear-gradient(90deg, #eba316 0%, #F59E0B 100%)`,
            transform: 'scaleX(0)',
            transformOrigin: 'left',
            transition: 'transform 0.3s ease',
          },
        ...
        <Card sx={{ 
          ...
          '&::before': {
            ...
            right: 0,
            height: '4px',
            background: `linear-gradient(90deg, #ef6141 0%, #F97316 100%)`,
            transform: 'scaleX(0)',
            transformOrigin: 'left',
            transition: 'transform 0.3s ease',
          },
                      ...
                      <ResponsiveContainer width="100%" height={400}>
                        <PieChart>
                          <defs>
                            {(() => {
                              const colors = [
                                '#A7F3D0', '#10B981', '#059669', '#0D9488', '#134E4A', '#6EE7B7',
                              ];
