                  ...
                  <FormControlLabel
                    ...
                    sx={{
                      ...
                      background: idType === "dni" 
                        ? 'linear-gradient(135deg, rgba(46, 125, 50, 0.15) 0%, rgba(46, 125, 50, 0.05) 100%)' 
                        : '#FFFFFF',
                      cursor: "pointer",
                      transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
                      display: "flex",
                      alignItems: "center",
                      boxShadow: idType === "dni" ? '0 2px 8px rgba(46, 125, 50, 0.2)' : 'none',
                      "&:hover": {
                        borderColor: '#2E7D32',
                      ...
                      "& .MuiFormControlLabel-label": {
                        color: idType === "dni" ? '#2E7D32' : '#000000',
                  ...
                  <FormControlLabel
                    ...
                    sx={{
                      ...
                      background: idType === "cee" 
                        ? 'linear-gradient(135deg, rgba(255, 111, 0, 0.15) 0%, rgba(255, 111, 0, 0.05) 100%)' 
                        : '#FFFFFF',
                      cursor: "pointer",
                      transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
                      display: "flex",
                      alignItems: "center",
                      boxShadow: idType === "cee" ? '0 2px 8px rgba(255, 111, 0, 0.2)' : 'none',
                      "&:hover": {
                        borderColor: '#FF6F00',
                      ...
                      "& .MuiFormControlLabel-label": {
                        color: idType === "cee" ? '#FF6F00' : '#000000',
                        ...
                        endAdornment: (
                          <IconButton
                            ...
                            sx={{
                              ...
                              transition: 'all 0.2s ease',
                              "&:hover": {
                                bgcolor: 'rgba(255, 111, 0, 0.15) !important',
                                transform: 'scale(1.1)',
