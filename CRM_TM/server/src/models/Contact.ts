...
interface ContactCreationAttributes extends Optional<ContactAttributes, 'id' | 'phone' | 'mobile' | 'jobTitle' | 'companyId' | 'address' | 'city' | 'state' | 'country' | 'postalCode' | 'website' | 'leadStatus' | 'tags' | 'notes' | 'createdAt' | 'updatedAt'> {}
