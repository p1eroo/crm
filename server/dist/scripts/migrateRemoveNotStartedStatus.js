...
async function migrateRemoveNotStartedStatus() {
    try {
        ...
        const [tasksWithNotStarted] = await database_1.sequelize.query(`
    ...
    `, { type: sequelize_1.QueryTypes.SELECT });
      ...
      `);
        ...
        const enumValues = await database_1.sequelize.query(`
      SELECT e.enumlabel
      FROM pg_enum e
    ...
    `, { type: sequelize_1.QueryTypes.SELECT });
      ...
      `);
        ...
        const finalEnumValues = await database_1.sequelize.query(`
      SELECT e.enumlabel
      FROM pg_enum e
      JOIN pg_type t ON e.enumtypid = t.oid
      WHERE t.typname = 'task_status_enum'
